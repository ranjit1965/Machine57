...
cat >>/etc/hosts<<EOF
192.168.57.100   k8s57master.example.com     k8s57master  km1
192.168.57.101   k8s57worker1.example.com    k8s57worker1 kw1
192.168.57.102   k8s57worker2.example.com    k8s57worker2 kw2
192.168.57.103   k8s57worker3.example.com    k8s57worker3 kw3
192.168.57.104   k8s57worker4.example.com    k8s57worker4 kw4
EOF
